...
namespace EntityFrameworkDBFirst_DAL
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> SP_GetOrdersDetailsByQuantity(Nullable<short> quantity)
        {
            var quantityParameter = quantity.HasValue ?
                new ObjectParameter("quantity", quantity) :
                new ObjectParameter("quantity", typeof(short));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_GetOrdersDetailsByQuantity", quantityParameter);
        }
        ...
        public virtual int sp_IkiSayiyiTopla(Nullable<int> sayi1, Nullable<int> sayi2, ObjectParameter sonuc)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_IkiSayiyiTopla", sayi1Parameter, sayi2Parameter, sonuc);
        }
        ...
        public virtual ObjectResult<string> sp_KategoriGuncelle(Nullable<int> id, string yeniAd, string yeniAciklama, byte[] yeniResim)
        {
            ...
            var yeniAciklamaParameter = yeniAciklama != null ?
                new ObjectParameter("YeniAciklama", yeniAciklama) :
                new ObjectParameter("YeniAciklama", typeof(string));
    
            var yeniResimParameter = yeniResim != null ?
                new ObjectParameter("yeniResim", yeniResim) :
                new ObjectParameter("yeniResim", typeof(byte[]));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("sp_KategoriGuncelle", idParameter, yeniAdParameter, yeniAciklamaParameter, yeniResimParameter);
        }
        ...
        public virtual int SP_YeniKategoriEkle(string kategoriAd, string kategoriAciklaması, byte[] resim)
        {
            ...
            var kategoriAciklamasıParameter = kategoriAciklaması != null ?
                new ObjectParameter("kategoriAciklaması", kategoriAciklaması) :
                new ObjectParameter("kategoriAciklaması", typeof(string));
    
            var resimParameter = resim != null ?
                new ObjectParameter("resim", resim) :
                new ObjectParameter("resim", typeof(byte[]));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_YeniKategoriEkle", kategoriAdParameter, kategoriAciklamasıParameter, resimParameter);
        }
